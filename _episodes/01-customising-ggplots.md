...
# Instead, please edit 01-customising-ggplots.md in _episodes_rmd/
...
~~~
Error in ggplot(percent_wall_type, aes(x = respondent_wall_type, y = percent)): could not find function "ggplot"
~~~
{: .error}
...
~~~
Error in ggplot(percent_items, aes(x = village, y = percent)): could not find function "ggplot"
~~~
{: .error}
...
~~~
Error in theme(axis.text.x = element_text(colour = "grey20", size = 12, : could not find function "theme"
~~~
{: .error}
