...
keypoints:
   ...
   - "Histograms and density plots are useful tools to visualise the distribution of a continuous variable."
...
That's a bit better but it is difficult to distinguish adjacent bars of the same height.
