...
This creates stacked bars for each wall type with the height of the different
...
of functions provides some commonly used computed aesthetics, like the bar height
...
> villages. A more interesting question might be what the makeup of wall types
